...
# extensions, which stock PostgreSQL does not ship. 0008 is written to install
# without them so the Phase 8 promotion/provenance logic stays covered here.
for f in drizzle/migrations/0000_fundmatch_core_schema.sql \
         ...
         drizzle/migrations/0008_phase8_document_processing.sql; do
  echo "applying $f"
